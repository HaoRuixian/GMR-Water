function [pseudorange_azi, pseudorange_all, pseudorange_data] = Batch_rinex2pseudorangefile_2(obsstr, sp3str, station_info_all, settings)
% Extract Pseudorange information from RINEX3 files
...
if isfield(data,'GPS')
    ...
    pseudorange_data.GPS = GPS_SNR;
    pseudorange_all.GPS = GPS_all;
    pseudorange_azi.GPS = GPS_SNR_azi;
...
if isfield(data,'GLONASS')
    ...
    pseudorange_data.GLONASS = GLONASS_SNR;
    pseudorange_all.GLONASS = GLONASS_all;
    pseudorange_azi.GLONASS = GLONASS_SNR_azi;
...
if isfield(data,'Galileo')
    ...
    pseudorange_data.GALILEO = GALILEO_SNR;
    pseudorange_all.GALILEO = GALILEO_all;
    pseudorange_azi.GALILEO = GALILEO_SNR_azi;
...
if isfield(data,'BeiDou')
    ...
    pseudorange_data.BDS = BDS_SNR;
    pseudorange_all.BDS  = BDS_all;
    pseudorange_azi.BDS  = BDS_SNR_azi;
